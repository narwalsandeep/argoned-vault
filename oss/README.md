...
Maintainers use this directory to publish **full-code** mirrors to the public [narwalsandeep/argoned-vault](https://github.com/narwalsandeep/argoned-vault) repository.
...
See [docs/self-host.md](../docs/self-host.md) for what self-hosters receive.
