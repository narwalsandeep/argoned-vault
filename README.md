...
**Argoned Vault** is a production-grade secrets manager built for people who want **real cryptography**, **clean self-hosting**, and **no vendor lock-in**. This repository is the **public MIT release** — the same application that powers the hosted service at [argoned.com](https://argoned.com), without feature stripping.

| | Hosted ([argoned.com](https://argoned.com)) | Self-hosted (this repo) |
|--|---------------------------------------------|-------------------------|
| **Code** | Private development mirror | Public release at tagged commits |
| **License** | Proprietary (operator) | **MIT** |
| **Features** | Full product | **Same** — vault, billing, admin, import, website |
...
| **Website** | Included marketing site (`website/`) for product pages |
...
| **Marketing site** | Angular 21+, nginx (prod) | [`website/`](website/) |
