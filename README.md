...
[Website](https://argoned.com) · [Self-host guide](SELF-HOST.md) · [Security](SECURITY.md) · [Contributing](CONTRIBUTING.md)

<br>

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge)](LICENSE)
[![Zero-knowledge](https://img.shields.io/badge/Architecture-Zero--Knowledge-2ea043?style=for-the-badge&logo=lock&logoColor=white)](#why-the-cryptography-is-built-this-way)
[![Docker](https://img.shields.io/badge/Deploy-Docker%20Compose-2496ED?style=for-the-badge&logo=docker&logoColor=white)](SELF-HOST.md)
...
[![Crypto](https://img.shields.io/badge/Crypto-AES--256--GCM%20%7C%20Argon2id-informational?style=flat-square)](#why-the-cryptography-is-built-this-way)
[![AEAD](https://img.shields.io/badge/Per--item-Encryption-2ea043?style=flat-square)](#why-the-cryptography-is-built-this-way)
...
**Argoned Vault** is a production-grade, zero-knowledge secrets manager — **MIT licensed** and ready to self-host. This repository contains the vault application: Angular UI, Slim PHP API, platform admin, bulk import, Docker Compose deployment, and tests.
...
> Cryptography overview: see [Why the cryptography is built this way](#why-the-cryptography-is-built-this-way) below.
...
| `searchable_words` | Plaintext tokens | **Yes** — search UX trade-off (see trust boundary section below) |
...
| **Deploy** | Docker Compose v2 | [`SELF-HOST.md`](SELF-HOST.md) |
...
Full instructions: **[SELF-HOST.md](SELF-HOST.md)**
...
|----------|-------------|
| [SELF-HOST.md](SELF-HOST.md) | Self-hosting from scratch |
| [SECURITY.md](SECURITY.md) | Report vulnerabilities |
| [CONTRIBUTING.md](CONTRIBUTING.md) | Contributions |

Cryptography, architecture diagrams, and threat-model notes are in this README.
...
├── docker-compose.prod.yml  # Optional nginx + PHP-FPM overlay for production
