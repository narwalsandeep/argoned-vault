...
export const VAULT_FILE_MAX_BYTES = 16 * 1024 * 1024;
export const VAULT_FILE_TOTAL_BYTES = 1024 * 1024 * 1024;
export const VAULT_FILE_MAX_PER_VAULT_ITEM = 32;
 ...
 */
/** Human-readable per-file cap for UI copy (e.g. "16 MB"). */
export function vaultFileMaxSizeLabel(): string {
  return `${VAULT_FILE_MAX_BYTES / (1024 * 1024)} MB`;
}
