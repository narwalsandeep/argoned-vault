...
import { SettingsSharesPanelComponent } from './settings-shares-panel.component';

export type SettingsTabId = 'profile' | 'recovery' | 'shares';
...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, VaultProfileBootstrapComponent, SettingsSharesPanelComponent],
  template: `
    <div class="page-content page-pad--settings settings-page-fill text-left">
      <div class="settings-layout">
        <div class="settings-main">
          ...
          @if (activeTab() === 'shares') {
            <div
              id="settings-panel-shares"
              role="tabpanel"
              [attr.aria-labelledby]="'settings-tab-shares'"
              class="settings-tab-panel"
            >
              <app-settings-shares-panel />
            </div>
          }
        </div>
...
export class SettingsComponent {
  ...
  constructor(
    ...
    if (tabParam === 'shares' || tabParam === 'recovery' || tabParam === 'profile') {
