...
import { PRICING_OPEN_SOURCE_REPO_LABEL, PRICING_OPEN_SOURCE_REPO_URL } from '../pricing/pricing.constants';
        ...
        <div class="docs-main-column">
          <div class="docs-body">
              ...
              <div class="docs-def-block">
                ...
                <div class="docs-def-row">
                  ...
                  <p class="docs-def-desc">
                    ...
                    <strong class="text-app-text">Pricing</strong>: plans copy + link to the MIT-licensed open-source repo
                    (<a [href]="openSourceRepoUrl" class="font-medium text-app-main-accent hover:underline" target="_blank" rel="noopener noreferrer">{{ openSourceRepoLabel }}</a>).
                  </p>
                </div>
              </div>
            </section>
            ...
            <section class="docs-section" id="repo" aria-labelledby="docs-repo-h">
              ...
              <div class="docs-prose">
                <p>
                  Authoritative markdown in <code>docs/</code> (not rendered here). Start with <code>README.md</code>, then:
                </p>
                <p>
                  The public MIT mirror for self-hosting lives on GitHub at
                  <a [href]="openSourceRepoUrl" class="font-medium text-app-main-accent hover:underline" target="_blank" rel="noopener noreferrer">{{ openSourceRepoLabel }}</a>.
                </p>
                <ul>
...
export class DocsComponent {
  public readonly openSourceRepoUrl = PRICING_OPEN_SOURCE_REPO_URL;
  public readonly openSourceRepoLabel = PRICING_OPEN_SOURCE_REPO_LABEL;
