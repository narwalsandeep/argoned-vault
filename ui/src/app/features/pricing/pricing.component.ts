...
import { APP_PLAN_CATALOG, PRICING_OPEN_SOURCE_REPO_LABEL, PRICING_OPEN_SOURCE_REPO_URL, PUBLIC_PLAN_DISPLAY_PRICES } from './pricing.constants';
...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, AppShellModalComponent, UiSpinnerComponent],
...
export class PricingComponent {
  ...
  public readonly repoLabel = PRICING_OPEN_SOURCE_REPO_LABEL;
  public readonly displayPrices = PUBLIC_PLAN_DISPLAY_PRICES;
  public readonly currentPlan = signal<PricingPlanKey | null>(null);
  public readonly pageLoading = signal(true);
  ...
  public goToPaymentLink(plan: 'pro' | 'lifetime'): void {
    if (plan === 'lifetime' && !this.showLifetimeOnPricing) {
      return;
    }
