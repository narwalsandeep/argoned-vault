        ...
        <article class="auth-legal-card">
          <div class="docs-prose text-app-text">
            ...
            <section class="auth-legal-section">
              <h3>Lifetime tier</h3>
              <p>
                <strong>Lifetime</strong> means the Lifetime plan limits and features you paid for are available for as long as we
                reasonably operate the Argoned vault service as this product. It is not a promise that the business or product will
                exist forever, but that you will not be charged again for that tier while the service continues under substantially
                the same offering.
              </p>
            </section>
            <section class="auth-legal-section">
              <h3>Refunds</h3>
              <p>
                For the <strong>Lifetime</strong> tier only, you may request a refund only within the <strong>first 30 calendar
                days</strong> after your purchase completes, and only to the extent our payment processor and applicable law allow.
                After that window, Lifetime fees are not refundable except where the law requires otherwise. Subscription (Pro)
                billing follows the renewal and cancellation rules shown at checkout and in your Stripe customer materials.
              </p>
            </section>
            <section class="auth-legal-section">
