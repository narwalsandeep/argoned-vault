...
return [
    ...
    'security' => [
        ...
        'share_rate_limit' => [
            'window_seconds' => (int) (getenv('RATE_LIMIT_WINDOW_SECONDS') ?: 60),
            'fetch_max' => (int) (getenv('RATE_LIMIT_SHARE_FETCH_MAX') ?: 30),
            'fetch_per_id_max' => (int) (getenv('RATE_LIMIT_SHARE_FETCH_PER_ID_MAX') ?: 10),
            'create_max' => (int) (getenv('RATE_LIMIT_SHARE_CREATE_MAX') ?: 20),
            'create_window_seconds' => (int) (getenv('RATE_LIMIT_SHARE_CREATE_WINDOW_SECONDS') ?: 3600),
        ],
        'account_recovery' => [
    ...
    'lifetime_plan_offered' => (getenv('UI_SHOW_LIFETIME_PRICING') ?: 'false') === 'true',
    ...
    'vault' => [
        ...
        'share_max_active_per_user' => (int) (getenv('VAULT_SHARE_MAX_ACTIVE_PER_USER') ?: 20),
    ],
    /**
