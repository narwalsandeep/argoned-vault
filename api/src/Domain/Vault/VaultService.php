...
final class VaultService implements RecoveryArtifactReader, VaultActiveItemCountReader
{
    ...
    public function __construct(
        ...
        private readonly VaultFieldShareRepository $fieldShares,
    ) {
    }
     ...
     * @return list<array<string,mixed>>
     */
    public function listItemMetadata(string $userId, string $search = '', bool $searchExactWord = false, bool $searchCaseSensitive = false): array
    {
        ...
        return array_values(array_filter(
            $rows,
            static fn (array $row): bool => VaultListItemSearch::matches($search, $row, $searchExactWord, $searchCaseSensitive),
        ));
    }
    ...
    public function deleteItem(string $userId, string $id): bool
    {
        ...
        $this->fieldShares->deleteByVaultItemId($userId, $id);
