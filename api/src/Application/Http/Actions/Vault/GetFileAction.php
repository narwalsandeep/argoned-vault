...
final class GetFileAction implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $file = $this->vaultService->getFile($userId, $id);
        if ($file === null) {
            return JsonResponder::write(new Response(), ['error' => 'not_found'], 404);
        }

        return JsonResponder::write(new Response(), ['status' => 'ok', 'file' => $file]);
    }
}
